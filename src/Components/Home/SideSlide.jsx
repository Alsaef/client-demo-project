...
const SideSlide = () => {
  ...
  if (!visiable) {
    ...
    return (
        <div className='z-0'>
            <label  htmlFor="cart-drawer" className="fixed right-0 top-1/2 -translate-y-1/2 z-40 bg-orange-500 text-white rounded-l-xl p-2.5 shadow-lg text-center flex flex-col items-center justify-center cursor-pointer hover:bg-orange-600 transition-colors">
